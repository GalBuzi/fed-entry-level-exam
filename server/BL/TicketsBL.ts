...
export const filterTickets = function(searchVal: string, pageNum: number, 
    tempData : Ticket[] ,matchesArrBeforeAfter: string[] ,matchesArrEmail:string[]) : filteredResults{
